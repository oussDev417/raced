    ...
    <div class="ul-container">
        ...
        <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4 justify-content-center">
            ...
            @if(isset($about) && $about->values)
                ...
                <!-- Conteneur pour l'image et les valeurs -->
                <div class="values-container">
                    <!-- Afficher l'image si elle existe -->
                    @if($imageSrc)
                        <div class="values-image text-center">
                            <img src="{{ $imageSrc }}" alt="Image des valeurs" style="max-width: 100%; height: auto;">
                        </div>
                    @endif
...
.values-image {
    margin-bottom: 20px; /* Espace entre l'image et les valeurs */
}
...
.values-list .col {
    margin: 10px; /* Espace entre les valeurs */
}
</style>