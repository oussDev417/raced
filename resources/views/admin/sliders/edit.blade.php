...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Modifier le slider</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <p>Image actuelle :</p>
                                <img src="{{ asset('storage/' . $slider->image) }}" alt="{{ $slider->title }}" class="img-thumbnail" style="max-height: 200px;">
                            </div>
                            
                            <div id="image-preview" class="mt-2 d-none">
                                <p>Nouvelle image :</p>
                                <img src="#" alt="Aperçu de la nouvelle image" class="img-thumbnail" style="max-height: 200px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('button_text_2') is-invalid @enderror" id="button_text_2" name="button_text_2" value="{{ old('button_text_2', $slider->button_text_2) }}">
                            @error('button_text_2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('button_link_2') is-invalid @enderror" id="button_link_2" name="button_link_2" value="{{ old('button_link_2', $slider->button_link_2) }}">
                            @error('button_link_2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
