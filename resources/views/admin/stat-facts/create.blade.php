...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Ajouter une statistique</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.stat-facts.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('counter') is-invalid @enderror" 
                                id="counter" name="counter" value="{{ old('counter') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('counter_after') is-invalid @enderror" 
                                id="counter_after" name="counter_after" value="{{ old('counter_after') }}">
