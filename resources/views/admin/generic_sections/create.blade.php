...
@section('title', 'Ajouter une Section Générique')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Ajouter une Section Générique</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.generic_sections.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control form-control-color @error('background_color') is-invalid @enderror" id="background_color" name="background_color" value="{{ old('background_color', '#ffffff') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control form-control-color @error('text_color') is-invalid @enderror" id="text_color" name="text_color" value="{{ old('text_color', '#000000') }}">
                                    @error('text_color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
        ...
        document.getElementById('image').addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                reader.onload = function(e) {
                    // Créer un élément d'aperçu si non existant
