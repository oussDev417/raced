                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Nom d'utilisateur" value="{{ old('username') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="Téléphone" value="{{ old('phone') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-center mb-3">
                                <img src="{{ asset('assets/images/default-avatar.png') }}" alt="Avatar" class="rounded-circle img-fluid mb-2" width="150" height="150" id="avatar-preview">
                            </div>
