...
@section('title', 'Modifier un Fun Fact')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Modifier le Fun Fact</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.fun-facts.update', $funFact) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('count') is-invalid @enderror" id="count" name="count" value="{{ old('count', $funFact->count) }}" required min="0">
                            @error('count')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
